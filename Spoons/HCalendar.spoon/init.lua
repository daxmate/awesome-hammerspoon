...
local function updateHcalCanvas()
    ...
    local firstdayofnextmonth = os.time({
        year = currentmonth == 12 and currentyear + 1 or currentyear,
    ...
    for i = 1, lastdayofcurrentmonth do
        ...
        if mappedweekdaystr == "六" or mappedweekdaystr == "日" then
    ...
    obj.canvas[2].frame.w = tostring((lastdayofcurrentmonth * 24 + 20) /
                                         obj.hcalw)
end
